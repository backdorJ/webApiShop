...
namespace WebApiShop.Migrations
{
    ...
    [Migration("20231017163942_AddCarAndCountryRealshion")]
    partial class AddCarAndCountryRealshion
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebApiShop.Models.Employee", b =>
                {
                    b.HasOne("WebApiShop.Models.Peet", "Peet")
                        .WithMany()
                        .HasForeignKey("PeetId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
